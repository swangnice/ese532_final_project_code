...
entry:
  ...
  %s1_copy = bitcast i8* %malloccall to [32768 x i8]*
  ...
  %0 = bitcast i8* %s1 to [32768 x i8]*
  %1 = bitcast i8* %temp_out_buffer to [2048 x i8]*
  call fastcc void @copy_in([32768 x i8]* %0, [32768 x i8]* %s1_copy, i32* %length, i32* nonnull align 512 %length_copy, i32* %is_dup, i32* nonnull align 512 %is_dup_copy, i32* %dup_index, i32* nonnull align 512 %dup_index_copy, [2048 x i8]* %1, [2048 x i8]* nonnull align 512 %temp_out_buffer_copy, i32* %temp_out_buffer_size, i32* nonnull align 512 %temp_out_buffer_size_copy)
  %2 = getelementptr inbounds [2048 x i8], [2048 x i8]* %temp_out_buffer_copy, i32 0, i32 0
  call void @apatb_lzw_compress_hw_hw(i8* %malloccall, i32* %length_copy, i32* %is_dup_copy, i32* %dup_index_copy, i8* %2, i32* %temp_out_buffer_size_copy)
  call fastcc void @copy_out([32768 x i8]* %0, [32768 x i8]* %s1_copy, i32* %length, i32* nonnull align 512 %length_copy, i32* %is_dup, i32* nonnull align 512 %is_dup_copy, i32* %dup_index, i32* nonnull align 512 %dup_index_copy, [2048 x i8]* %1, [2048 x i8]* nonnull align 512 %temp_out_buffer_copy, i32* %temp_out_buffer_size, i32* nonnull align 512 %temp_out_buffer_size_copy)
...
define internal fastcc void @copy_in([32768 x i8]* readonly, [32768 x i8]* noalias, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512, [2048 x i8]* readonly, [2048 x i8]* noalias align 512, i32* readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a32768i8([32768 x i8]* %1, [32768 x i8]* %0)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a32768i8([32768 x i8]* noalias, [32768 x i8]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [32768 x i8]* %0, null
  %3 = icmp eq [32768 x i8]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr = getelementptr [32768 x i8], [32768 x i8]* %0, i64 0, i64 %for.loop.idx1
  %src.addr = getelementptr [32768 x i8], [32768 x i8]* %1, i64 0, i64 %for.loop.idx1
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([32768 x i8]*, [32768 x i8]* noalias readonly, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512, [2048 x i8]*, [2048 x i8]* noalias readonly align 512, i32*, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a32768i8([32768 x i8]* %0, [32768 x i8]* %1)
...
entry:
  %6 = bitcast i8* %0 to [32768 x i8]*
  %7 = bitcast i8* %4 to [2048 x i8]*
  call void @copy_out([32768 x i8]* null, [32768 x i8]* %6, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3, [2048 x i8]* null, [2048 x i8]* %7, i32* null, i32* %5)
  %8 = bitcast [32768 x i8]* %6 to i8*
  %9 = bitcast [2048 x i8]* %7 to i8*
  call void @lzw_compress_hw_hw_stub(i8* %8, i32* %1, i32* %2, i32* %3, i8* %9, i32* %5)
  call void @copy_in([32768 x i8]* null, [32768 x i8]* %6, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3, [2048 x i8]* null, [2048 x i8]* %7, i32* null, i32* %5)
  ret void
}
