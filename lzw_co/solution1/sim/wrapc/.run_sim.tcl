...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lzw_compress_hw.autotvin.dat"
	set constFileTvOut       "lzw_compress_hw.autotvout.dat"
	set constFileHdlTvIn     "lzw_compress_hw.autohdltvin.dat"
	set constFileHdlTvOut    "lzw_compress_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
