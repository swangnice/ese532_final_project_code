...
entity lzw_compress_hw_control_s_axi is
generic (
...
end entity lzw_compress_hw_control_s_axi;
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_TEMP_OUT_BUFFER_DATA_1 =>
                        rdata_data <= RESIZE(int_temp_out_buffer(63 downto 32), 32);
                    when ADDR_TEMP_OUT_BUFFER_SIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_temp_out_buffer_size(31 downto 0), 32);
                    when ADDR_TEMP_OUT_BUFFER_SIZE_DATA_1 =>
                        rdata_data <= RESIZE(int_temp_out_buffer_size(63 downto 32), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    is_dup               <= STD_LOGIC_VECTOR(int_is_dup);
    dup_index            <= STD_LOGIC_VECTOR(int_dup_index);
    temp_out_buffer      <= STD_LOGIC_VECTOR(int_temp_out_buffer);
    temp_out_buffer_size <= STD_LOGIC_VECTOR(int_temp_out_buffer_size);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TEMP_OUT_BUFFER_DATA_0) then
                    int_temp_out_buffer(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_temp_out_buffer(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TEMP_OUT_BUFFER_DATA_1) then
                    int_temp_out_buffer(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_temp_out_buffer(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TEMP_OUT_BUFFER_SIZE_DATA_0) then
                    int_temp_out_buffer_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_temp_out_buffer_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TEMP_OUT_BUFFER_SIZE_DATA_1) then
                    int_temp_out_buffer_size(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_temp_out_buffer_size(63 downto 32));
                end if;
            end if;
        end if;
    end process;
