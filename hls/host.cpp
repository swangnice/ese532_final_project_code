...
//Get all UDP Packets and CDC
	...
	float cdc_latency = cdc_timer.latency() / 2800.0;
	float sha_latency = sha_timer.latency() / 2800.0;
	float dedup_latency = dedup_timer.latency() / 2800.0;
	float lzw_latency = lzw_timer.latency() / 4000.0;
	float overall_latency = overall_timer.latency() / 2800.0;
