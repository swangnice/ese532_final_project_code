...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "s1","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "s1","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "length","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "length_r","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "out_code","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "out_code","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "out_len","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "out_len","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "out_code", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "out_len", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"lzw_compress","role":"start","value":"0","valid_bit":"0"},{"name":"lzw_compress","role":"continue","value":"0","valid_bit":"4"},{"name":"lzw_compress","role":"auto_start","value":"0","valid_bit":"7"},{"name":"s1","role":"data","value":"16"},{"name":"length_r","role":"data","value":"28"},{"name":"out_code","role":"data","value":"40"},{"name":"out_len","role":"data","value":"52"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"lzw_compress","role":"start","value":"0","valid_bit":"0"},{"name":"lzw_compress","role":"done","value":"0","valid_bit":"1"},{"name":"lzw_compress","role":"idle","value":"0","valid_bit":"2"},{"name":"lzw_compress","role":"ready","value":"0","valid_bit":"3"},{"name":"lzw_compress","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	lzw_compress {
		gmem {Type IO LastRead 166 FirstWrite 161}
