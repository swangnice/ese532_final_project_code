...
void XLzw_compress_Set_length_r(XLzw_compress *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XLzw_compress_WriteReg(InstancePtr->Control_BaseAddress, XLZW_COMPRESS_CONTROL_ADDR_LENGTH_R_DATA, (u32)(Data));
    XLzw_compress_WriteReg(InstancePtr->Control_BaseAddress, XLZW_COMPRESS_CONTROL_ADDR_LENGTH_R_DATA + 4, (u32)(Data >> 32));
}

u64 XLzw_compress_Get_length_r(XLzw_compress *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XLzw_compress_ReadReg(InstancePtr->Control_BaseAddress, XLZW_COMPRESS_CONTROL_ADDR_LENGTH_R_DATA + 4) << 32;
    return Data;
}
