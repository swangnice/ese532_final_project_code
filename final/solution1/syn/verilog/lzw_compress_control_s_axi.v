...
// ==============================================================
`timescale 1ns/1ps
module lzw_compress_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_LENGTH_R_DATA_1 = 6'h20,
    ADDR_LENGTH_R_CTRL   = 6'h24,
    ADDR_OUT_CODE_DATA_0 = 6'h28,
    ADDR_OUT_CODE_DATA_1 = 6'h2c,
    ADDR_OUT_CODE_CTRL   = 6'h30,
    ADDR_OUT_LEN_DATA_0  = 6'h34,
    ADDR_OUT_LEN_DATA_1  = 6'h38,
    ADDR_OUT_LEN_CTRL    = 6'h3c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
